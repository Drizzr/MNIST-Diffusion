...
parser.add_argument("--guidance", type=float, default=8, help="guidance value")
parser.add_argument("--c", type=int, default=3, help="Class to sample from")
parser.add_argument("--model_path", type=str, default="checkpoints_CIFAR10/checkpoint_epoch_6_0.0%_estimated_loss_0.037", help="Path to the model")
...
forward = ForwardDiffusion(timesteps=time_steps, start=0.0001, end=0.02, device=DEVICE)
