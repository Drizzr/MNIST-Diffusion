...
parser.add_argument("--model_path", type=str, default="checkpoints_CIFAR10/checkpoint_epoch_6_0.0%_estimated_loss_0.037checkpoint_epoch_8_0.0%_estimated_loss_0.037", help="Path to the model")
